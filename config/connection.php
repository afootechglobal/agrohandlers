...
$website='http://localhost/agrohandlers.com';
//$website='https://www.agrohandlers.com';
//$website='https://dev.agrohandlers.com';
...
$product_id=$_SESSION['s_product_id'];
$shopsession=$_SESSION['shopsession'];
$s_customer_id=$_SESSION['customer_id'];

$blogsession=$_SESSION['blogsession'];
?>
