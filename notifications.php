...
<title>Notifications |<?php echo $user_fullname?>-<?php echo $thename?></title>
</head>
<body>
...
<div class="other-pages-title"  data-aos="fade-down" data-aos-duration="1200">
  <div class="title-div">
    <h1>Notifications <i class="fa fa-circle"></i></h1>
  </div>
</div>
        ...
        <div class="table-content-div">
          <div class="content-div-in">
            ...
            <div class="chart-div-notifications">
              <div class="text"><i class="fa fa-line-chart"></i> Notification for</div>
